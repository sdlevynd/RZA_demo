...
public partial class TlSlyRzaContext : DbContext
{
    public TlSlyRzaContext()
    {
    }

    public TlSlyRzaContext(DbContextOptions<TlSlyRzaContext> options)
        : base(options)
    {
    }
            ...
            entity.HasMany(d => d.Tickets).WithMany(p => p.Customers)
                .UsingEntity<Dictionary<string, object>>(
                    ...
                    j =>
                    {
                        ...
                        j.HasIndex(new[] { "TicketId" }, "fk2_idx");
